...
package SdCardPckg is
    ...
    -- Define the different types of SD cards.
  ...
  component SdCardCtrl is
    generic (
      ...
      CARD_TYPE_G     : boolean    := false  -- false=SD, true=SDHC  -- Type of SD card connected to this controller.
      );
    port (
...
architecture arch of SdCardCtrl is
  ...
  -- Reemplaza realmax de CommonPckg
  function realmax(a, b : real) return real is
  begin
    if a > b then return a; else return b; end if;
  end function;

  -- Reemplaza IntMax de CommonPckg  
  function IntMax(a, b : natural) return natural is
  begin
    if a > b then return a; else return b; end if;
  end function;
          ...
          when WAIT_FOR_HOST_RW =>  -- Wait for the host to read or write a block of data from the SD card.
            ...
            if rd_i = '1' then  -- send READ command and address to the SD card.
              ...
              if continue_i = '1' then  -- Multi-block read. Use stored address.
                if CARD_TYPE_G = false then  -- SD cards use byte-addressing, 
